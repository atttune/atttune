...
<?php $title_for_layout = $tv['flt_title_visite_me']; ?>
...
<ul class="nav nav-tabs" id="myj">
    <li <?php if(isset($pstat)&&($pstat==0)) echo 'class="active"' ;?>><a href="<?php echo Router::url('interactions/visite_me'); ?>"><?php echo $tv['g_all'] ;?></a></li>
    <li <?php if(isset($pstat)&&($pstat==1)) echo 'class="active"' ;?>><a href="<?php echo Router::url('interactions/visite_me/11'); ?>"><?php echo $tv['g_day'] ;?></a></li>
    <li <?php if(isset($pstat)&&($pstat==2)) echo 'class="active"' ;?>><a  href="<?php echo Router::url('interactions/visite_me/22'); ?>"><?php echo $tv['g_week'] ;?></a></li>
    <li <?php if(isset($pstat)&&($pstat==3)) echo 'class="active"' ;?>><a href="<?php echo Router::url('interactions/visite_me/33'); ?>"><?php echo $tv['g_month'] ;?></a></li>
    <li <?php if(isset($pstat)&&($pstat==4)) echo 'class="active"' ;?>><a href="<?php echo Router::url('interactions/visite_me/44'); ?>"><?php echo $tv['g_online'] ;?></a></li>
</ul>

   <h3><?php echo $tv['flt_visite_me'] ;?></h3> 
<hr>
<div class="row">
	<div class="col-md-12">
