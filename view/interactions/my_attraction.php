...
<?php $title_for_layout = $tv['flt_title_my_attraction']; ?>
...
<ul class="nav nav-tabs" id="myj">
    <li class="active"><a href="<?php echo Router::url('interactions/my_attraction'); ?>"><?php echo $tv['g_all'] ;?></a></li>
    <li><a href="<?php echo Router::url('interactions/my_attraction/11'); ?>"><?php echo $tv['g_day'] ;?></a></li>
    <li><a  href="<?php echo Router::url('interactions/my_attraction/22'); ?>"><?php echo $tv['g_week'] ;?></a></li>
    <li><a href="<?php echo Router::url('interactions/my_attraction/33'); ?>"><?php echo $tv['g_month'] ;?></a></li>
    <li><a href="<?php echo Router::url('interactions/my_attraction/44'); ?>"><?php echo $tv['g_online'] ;?></a></li>
</ul>

   <h3><?php echo $tv['flt_my_attraction'] ;?></h3> 
<hr>
<div class="row">
	<div class="col-md-12">
