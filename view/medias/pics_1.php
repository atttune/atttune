                    ...
                    <div class="col-md-4">
                      <?php for($k=$gcol;$k<$nbpics;$k=$k+3):?>
                        ...
                        <div class="panel panel-atttune">
                            ...
                            <a href="<?php echo Router::url('medias/view_pics/user:'.$v->user_id.'/id:'.$v->id); ?>"><img src="<?php echo Router::webroot('img/'.$v->file_large); ?>" /></a>
                            </div>
                          <div class="panel-footer">
                        
                    <?php if($slike[$v->id]==0):?>
                    <a href="<?php echo Router::url('medias/like_picture/user:'.$v->user_id.'/id:'.$v->id); ?>" title="like"><i class="icon-heart"></i></a>
                    <?php elseif($slike[$v->id]==1): ?>
                    <a href="<?php echo Router::url('medias/like_picture/user:'.$v->user_id.'/id:'.$v->id); ?>" title="unlike"><i class="icon-remove-sign"></i></a>
                    <?php endif ;?>
                    
                    <?php if((!isset($user_id))||($me==1)): ?>
                   <a href="<?php echo Router::url('medias/pics_delete/id:'.$v->id); ?>">X</a>
                   <a href="<?php echo Router::url('medias/pics_main/id:'.$v->id); ?>">M</a>
                    <?php endif ;?>
                        </div>
