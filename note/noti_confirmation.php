<table cellspacing="0" border="0" height="100%" style="" bgcolor="#ffffff" cellpadding="0" width="100%">
    ...
    <table cellspacing="0" cellpadding="0" width="400">
        ...
        <tr>
            <td align="left" valign="top" style="padding:0 0 15px 0;">
                <font size="4" color="#333" face="Helvetica Neue, Arial, Helvetica, sans-serif" style="font-size:16px;line-height:25px;"><?php echo $this->s['click2confirm'] ;?> <a href="http://www.atttune.com/users/confirm/<?php echo $data['data'].'/'.$data['key'] ;?>" style="color:#0C695D" target="_blank"><?php echo $this->s['confirmadress'] ;?></a>
                </font>
            </td>
        </tr>
        <tr>
